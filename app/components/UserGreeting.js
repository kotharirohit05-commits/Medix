        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <span className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">MediTrack</span>
            </Link>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className={`md:hidden fixed inset-y-0 right-0 w-64 bg-white dark:bg-gray-800 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
